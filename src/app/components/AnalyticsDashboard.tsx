...
export function AnalyticsDashboard() {
  ...
  const avgRevenuePerBooking = Math.round(totalRevenue / totalBookings);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="text-xs text-green-400 mt-1">↑ 23% vs last week</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-xs text-green-400 mt-1">↑ 18% vs last week</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-3xl font-bold text-white">{peakHour}</div>
          <div className="text-sm text-gray-400">Peak Hour</div>
          <div className="text-xs text-gray-500 mt-1">Most bookings</div>
        </motion.div>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-[#1A1A1A] border border-white/10 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold text-[#0047AB]">78%</p>
          </div>
          <div className="bg-[#1A1A1A] border border-white/10 rounded-lg p-4">
